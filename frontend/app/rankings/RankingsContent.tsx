...
export default function RankingsContent() {
  ...
  const rankingItems = [
    { rank: 1, courseName: 'Buddhist Psychology', courseId: 'course-1' },
    { rank: 2, courseName: 'Introduction to Film Studies', courseId: 'course-2' },
    { rank: 3, courseName: 'Creative Writing Workshop', courseId: 'course-3' },
    { rank: 4, courseName: 'Environmental Science Basics', courseId: 'course-4' },
    { rank: 5, courseName: 'Music Appreciation', courseId: 'course-5' },
    { rank: 6, courseName: 'Art History Survey', courseId: 'course-6' },
    { rank: 7, courseName: 'Philosophy of Ethics', courseId: 'course-7' },
    { rank: 8, courseName: 'Cultural Anthropology', courseId: 'course-8' },
    { rank: 9, courseName: 'World Literature', courseId: 'course-9' },
    { rank: 10, courseName: 'Social Psychology', courseId: 'course-10' },
  ];
